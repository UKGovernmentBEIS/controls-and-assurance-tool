...
namespace ControlAssuranceAPI.Models
{
    public class UnitOfWork : IDisposable
    {
        ...
        private NAOOutput2Repository nAOOutput2Repository;
        ...
        private PlatformRepository plateformRepository;
        ...
        public NAOOutput2Repository NAOOutput2Repository
        {
            get
            {
                return nAOOutput2Repository = nAOOutput2Repository ?? new NAOOutput2Repository(user, context);
            }
        }
        ...
        public PlatformRepository PlateformRepository
        {
            get
            {
                return plateformRepository = plateformRepository ?? new PlatformRepository(user, context);
            }
        }

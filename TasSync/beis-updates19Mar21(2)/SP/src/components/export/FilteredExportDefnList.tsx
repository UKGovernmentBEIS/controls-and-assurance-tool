...
export interface IFilteredExportDefnListProps {
    className?: string;
    columns: IColumn[];
    items: any[];
    filterText?: string;
...
export interface IFilteredExportDefnListState {
    Columns: IColumn[];
    FilteredItems: any[];
}

export class FilteredExportDefnList extends React.Component<IFilteredExportDefnListProps, IFilteredExportDefnListState> {



    constructor(props: IFilteredExportDefnListProps) {
        super(props);
    ...
    public componentDidUpdate(prevProps: IFilteredExportDefnListProps): void {

...
export default class Report1List extends React.Component<IReport1ListProps, IReport1ListState<IEntity>> {
    ...
    private naoOutputService: services.NAOOutputService = new services.NAOOutputService(this.props.spfxContext, this.props.api);
    ...
    private handleCreatePdf = (): void => {
        ...
        if (this.state.SelectedEntity) {
            ...
            this.naoOutputService.createPDF(outputId, spSiteUrl).then((res: string): void => {
    ...
    private handleDeletePdf = (): void => {
        ...
        if (this.state.SelectedEntity) {
            ...
            this.naoOutputService.deletePDFInfo(outputId).then((res: string): void => {

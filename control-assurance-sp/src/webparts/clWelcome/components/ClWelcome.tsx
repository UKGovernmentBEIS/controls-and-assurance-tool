...
import { IUserPermission, ICLDefForm, IEntity } from '../../../types';
...
export default class CLWelcome extends BaseUserContextWebPartComponent<types.IWebPartComponentProps, CLWelcomeState> {
  ...
  protected loadDefForm = (): Promise<ICLDefForm> => {
    return this.CLDefFormService.read(1).then((df: ICLDefForm): ICLDefForm => {
  ...
  private handleUpdatesClick = (): void => {
    const pageUrl = this.props.spfxContext.pageContext.web.absoluteUrl + "/SitePages/CLUpdates.aspx";

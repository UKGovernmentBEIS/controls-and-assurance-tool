...
import { IUserPermission, CLCase, ICLCase, IClCaseCounts, ICLDefForm, ICLWorker, IUser, ICLHiringMember, IPlatform } from '../../../types';
...
export default class ClUpdates extends BaseUserContextWebPartComponent<types.IWebPartComponentProps, ClUpdatesState> {
  ...
  public renderWebPart(): React.ReactElement<types.IWebPartComponentProps> {
    ...
    return (
      <React.Fragment>
        ...
        <MessageDialog hidden={this.state.HideCantCreateExtensionMessage} title={null} content="Cannot create extension. This case already has an extension in the system." handleOk={() => { this.setState({ HideCantCreateExtensionMessage: true },); }} />
      </React.Fragment>
    );
  }
  ...
  private handleSection2_ChangeFilterText = (event?: React.ChangeEvent<HTMLInputElement>, newValue?: string): void => {
    this.setState({ Section2_MainList_ListFilterText: newValue });
  }
  private handleSection3_ChangeFilterText = (event?: React.ChangeEvent<HTMLInputElement>, newValue?: string): void => {
    this.setState({ Section3_MainList_ListFilterText: newValue });
  }

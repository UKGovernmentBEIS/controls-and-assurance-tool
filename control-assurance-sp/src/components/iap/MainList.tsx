...
export default class MainList extends React.Component<IMainListProps, IMainListState<IEntity>> {
    ...
    private mainService: services.IAPUpdateService = new services.IAPUpdateService(this.props.spfxContext, this.props.api);
    ...
    private loadData = (): void => {
        ...
        const read: Promise<IEntity[]> = this.mainService.readAllWithFilters(userIds);
    ...
    public componentDidUpdate(prevProps: IMainListProps): void {
        if (prevProps.userIdsArr !== this.props.userIdsArr) {

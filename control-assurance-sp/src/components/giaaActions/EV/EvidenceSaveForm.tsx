...
import { IGIAAUpdateEvidence, GIAAUpdateEvidence } from '../../../types';
...
export interface IEvidenceSaveFormState {
    Loading: boolean;
    FormData: IGIAAUpdateEvidence;
    FormDataBeforeChanges: IGIAAUpdateEvidence;
    FormIsDirty: boolean;
    UploadStatus: string;
...
export default class EvidenceSaveForm extends React.Component<IEvidenceSaveFormProps, IEvidenceSaveFormState> {
    ...
    constructor(props: IEvidenceSaveFormProps, state: IEvidenceSaveFormState) {
        ...
        this.state = new EvidenceSaveFormState(props.updateId);
    }
    ...
    private saveEvidence = (): void => {
        ...
        if (this.validateEntity()) {
            ...
            let f: IGIAAUpdateEvidence = { ...this.state.FormData };
    ...
    private loadEvidence = (): Promise<void> => {
        let x = this.giaaUpdateEvidenceService.read(this.props.evidenceId).then((e: IGIAAUpdateEvidence): void => {
